import { DecodingMode, EntityDecoder } from './entities/decode.ts'
import { htmlDecodeTree } from './entities/decode-data-html.ts'
import { xmlDecodeTree } from './entities/decode-data-xml.ts'
